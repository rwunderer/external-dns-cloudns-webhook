...
func Test_GetLogFields(t *testing.T) {
	...
	testCases := []testCase{
		{
			name: "cloudnsChangeCreate",
			object: &cloudnsChangeCreate{
				ZoneID: "testZoneID",
		...
		{
			name: "cloudnsChangeUpdate",
			object: &cloudnsChangeUpdate{
				ZoneID: "testZoneID",
				Record: hdns.Record{
					ID: "recordID",
					Zone: &hdns.Zone{
		...
		{
			name: "cloudnsChangeDelete",
			object: &cloudnsChangeDelete{
				ZoneID: "testZoneID",
				Record: hdns.Record{
					ID: "recordID",
					Zone: &hdns.Zone{
