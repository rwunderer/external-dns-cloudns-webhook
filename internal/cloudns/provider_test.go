...
import (
	...
	hdns "github.com/jobstoit/cloudns-dns-go/dns"
...
// Test_NewClouDNSProvider tests NewClouDNSProvider().
...
// Test_Zones tests ClouDNSProvider.Zones().
...
// Test_AdjustEndpoints tests ClouDNSProvider.AdjustEndpoints().
...
// Test_Records tests ClouDNSProvider.Records().
...
// ClouDNSProvider.ensureZoneIDMappingPresent().
...
// Test_getRecordsByZoneID tests ClouDNSProvider.getRecordsByZoneID()
